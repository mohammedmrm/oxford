				...
				<div class="kt-portlet__body kt-portlet__body--fluid">
					<div class="kt-widget-19">
						...
						<div class="kt-widget-19__data">
							...
							<!--Doc: For the chart bars you can use state helper classes: kt-bg-success, kt-bg-info, kt-bg-danger. Refer: components/custom/colors.php -->
				...
				<div class="kt-portlet__body kt-portlet__body--fluid">
					<div class="kt-widget-21">
						...
						<div class="kt-widget-21__data">
							...
							<!--Doc: For the chart legend bullet colors can be changed with state helper classes: kt-bg-success, kt-bg-info, kt-bg-danger. Refer: components/custom/colors.php -->
				...
				<div class="kt-portlet__body">
					<div class="kt-widget-1">
						<ul class="nav nav-pills nav-tabs-btn nav-pills-btn-brand" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" data-toggle="tab" href="#kt_tabs_19_15dced0bf396bc" role="tab">
									<span class="nav-link-icon"><i class="flaticon2-graphic"></i></span>
									<span class="nav-link-title">Settings</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_tabs_19_25dced0bf396bc" role="tab">
									<span class="nav-link-icon"><i class="flaticon2-position"></i></span>
									<span class="nav-link-title">Code</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#kt_tabs_19_35dced0bf396bc" role="tab">
						...
						<div class="tab-content">
							<div class="tab-pane fade active show" id="kt_tabs_19_15dced0bf396bc" role="tabpanel">
							...
							<div class="tab-pane fade" id="kt_tabs_19_25dced0bf396bc" role="tabpanel">
								<div class="kt-widget-1__item">
									<div class="kt-widget-1__item-info">
										<a href="#" class="kt-widget-1__item-title">UI/UX Design</a>
										<div class="kt-widget-1__item-desc">Evrything you ever imagine</div>
							...
							<div class="tab-pane fade" id="kt_tabs_19_35dced0bf396bc" role="tabpanel">
								<div class="kt-widget-1__item">
									<div class="kt-widget-1__item-info">
										<a href="#" class="kt-widget-1__item-title">eCommerce Websites</a>
										<div class="kt-widget-1__item-desc">Shops, Fasion wep sites & atc</div>
