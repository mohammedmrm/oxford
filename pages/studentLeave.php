  ...
  <div class="kt-portlet kt-portlet--mobile">
    ...
    <div class="kt-portlet__body">
      <form id="filtterStudentsForm">
        ...
        <table class="table table-striped table-bordered table-hover responsive nowrap" id="tb-student">
          <thead>
            <tr>
              <th>#</th>
              <th>رقم الطالب</th>
...
<script type="text/javascript">
  var studnetsTable = $('#tb-student').DataTable({
    "bPaginate": false,
    "bLengthChange": false,
    "bFilter": false,
    serverPaging: true
    ...
    $.ajax({
      ...
      success: function(res) {
        ...
        $.each(res.data, function() {
          ...
          studnetsTable.rows.add([
            [`<img class="user-img" src="img/student/${this.img}"/>`,
              `<a href="?page=pages/showStudentLeave.php&reg=${this.student_number}" title="استمارة التسجيل">${this.student_number}</a>`,
              `<a target="_blank" href="contract.php?id=${this.id}" target="_blank">${this.name}</a>`,
              this.phone,
              this.start_date,
              `
